...
class Customer(ABC):
	@abstractmethod
	def generate_purchase_probabilities_from_offer(self, step_counter, common_state, vendor_specific_state, vendor_actions) -> np.array:  # pragma: no cover
		"""
		...
		Args:
			step_counter (int): the current step within the episode, this is required for e.g. seasonal fluctuations
