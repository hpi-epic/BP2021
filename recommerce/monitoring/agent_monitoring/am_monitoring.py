...
class Monitor():
    ...
    def run_marketplace(self) -> list:
        ...
        if self.configurator.separate_markets:
            ...
            watchers = [Watcher(config_market=self.configurator.marketplace.config) for _ in
                        range(len(self.configurator.agents))]
...
def main():  # pragma: no cover
    ...
    """
    monitor = Monitor()
    config_environment_am: AgentMonitoringEnvironmentConfig = EnvironmentConfigLoader.load(
