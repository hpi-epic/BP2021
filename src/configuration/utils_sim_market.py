...
def write_content_of_dict_to_overview_svg(manipulator, dictionary, episode) -> None:
	...
	manipulator.replace_one_value('a_garbage', str(dictionary['owner/throw_away']))
	manipulator.replace_one_value('a_inventory', str(dictionary['state/in_storage']['vendor_0']))
	manipulator.replace_one_value('a_price_new', str(dictionary['actions/price_new']['vendor_0']))
	manipulator.replace_one_value('a_price_used', str(dictionary['actions/price_refurbished']['vendor_0']))
	manipulator.replace_one_value('a_rebuy_price', str(dictionary['actions/price_rebuy']['vendor_0']))
	manipulator.replace_one_value('a_repurchases', str(dictionary['owner/rebuys']['vendor_0']))
	manipulator.replace_one_value('a_resource_cost', str(PRODUCTION_PRICE))
	manipulator.replace_one_value('a_resources_in_use', str(dictionary['state/in_circulation']))
	manipulator.replace_one_value('a_sales_new', str(dictionary['customer/purchases_new']['vendor_0']))
	manipulator.replace_one_value('a_sales_used', str(dictionary['customer/purchases_refurbished']['vendor_0']))
	manipulator.replace_one_value('b_competitor_name', 'vendor_1')
	manipulator.replace_one_value('b_inventory', str(dictionary['state/in_storage']['vendor_1']))
	manipulator.replace_one_value('b_price_new', str(dictionary['actions/price_new']['vendor_1']))
	manipulator.replace_one_value('b_price_used', str(dictionary['actions/price_refurbished']['vendor_1']))
	manipulator.replace_one_value('b_rebuy_price', str(dictionary['actions/price_rebuy']['vendor_1']))
	manipulator.replace_one_value('b_repurchases', str(dictionary['owner/rebuys']['vendor_1']))
	manipulator.replace_one_value('b_resource_cost', str(PRODUCTION_PRICE))
	manipulator.replace_one_value('b_sales_new', str(dictionary['customer/purchases_new']['vendor_1']))
	manipulator.replace_one_value('b_sales_used', str(dictionary['customer/purchases_refurbished']['vendor_1']))
