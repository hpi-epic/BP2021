...
def write_content_of_dict_to_overview_svg(manipulator, episode, episode_dictionary, cumulated_dictionary) -> None:
	...
	manipulator.replace_one_value('consumer_total_sales', str(episode * NUMBER_OF_CUSTOMERS - cumulated_dictionary['customer/buy_nothing']))
	manipulator.replace_one_value('a_competitor_name', 'vendor_0')
	manipulator.replace_one_value('a_throw_away', str(episode_dictionary['owner/throw_away']))
	manipulator.replace_one_value('a_garbage', str(cumulated_dictionary['owner/throw_away']))
	manipulator.replace_one_value('a_inventory', str(episode_dictionary['state/in_storage']['vendor_0']))
	manipulator.replace_one_value('a_profit', str(cumulated_dictionary['profits/all']['vendor_0']))
	manipulator.replace_one_value('a_price_new', str(episode_dictionary['actions/price_new']['vendor_0'] + 1))
	manipulator.replace_one_value('a_price_used', str(episode_dictionary['actions/price_refurbished']['vendor_0'] + 1))
	manipulator.replace_one_value('a_rebuy_price', str(episode_dictionary['actions/price_rebuy']['vendor_0'] + 1))
	manipulator.replace_one_value('a_repurchases', str(episode_dictionary['owner/rebuys']['vendor_0']))
	manipulator.replace_one_value('a_resource_cost', str(PRODUCTION_PRICE))
	manipulator.replace_one_value('a_resources_in_use', str(episode_dictionary['state/in_circulation']))
	manipulator.replace_one_value('a_sales_new', str(episode_dictionary['customer/purchases_new']['vendor_0']))
	manipulator.replace_one_value('a_sales_used', str(episode_dictionary['customer/purchases_refurbished']['vendor_0']))
	manipulator.replace_one_value('b_competitor_name', 'vendor_1')
	manipulator.replace_one_value('b_inventory', str(episode_dictionary['state/in_storage']['vendor_1']))
	manipulator.replace_one_value('b_profit', str(cumulated_dictionary['profits/all']['vendor_1']))
	manipulator.replace_one_value('b_price_new', str(episode_dictionary['actions/price_new']['vendor_1'] + 1))
	manipulator.replace_one_value('b_price_used', str(episode_dictionary['actions/price_refurbished']['vendor_1'] + 1))
	manipulator.replace_one_value('b_rebuy_price', str(episode_dictionary['actions/price_rebuy']['vendor_1'] + 1))
	manipulator.replace_one_value('b_repurchases', str(episode_dictionary['owner/rebuys']['vendor_1']))
