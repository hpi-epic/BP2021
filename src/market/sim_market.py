...
class CircularEconomy(SimMarket):
	...
	def complete_purchase(self, profits, customer_decision) -> None:
		...
		"""
		assert customer_decision >= 0 and customer_decision < 2 * self.get_number_of_vendors(), 'Invalid action of the customer! Note that you have two options per vendor!'
