...
test_scenarios = [
	(linear_sim_market.ClassicScenario, vendors.QLearningAgent),
	(linear_sim_market.MultiCompetitorScenario, vendors.QLearningAgent),
	(circular_sim_market.CircularEconomyMonopolyScenario, vendors.QLearningCEAgent),
	(circular_sim_market.CircularEconomyRebuyPriceMonopolyScenario, vendors.QLearningCERebuyAgent),
	(circular_sim_market.CircularEconomyRebuyPriceOneCompetitor, vendors.QLearningCERebuyAgent)
]
...
def test_training_with_tensorboard():
	...
	with patch('builtins.open', mock_open(read_data=json)) as mock_file:
		...
		reload(config)
		environment = linear_sim_market.ClassicScenario()
