...
# test_scenarios = [
# 	(sim_market.ClassicScenario(), vendors.QLearningAgent(sim_market.ClassicScenario().observation_space.shape[0], n_actions=10, optim=torch.optim.Adam)),
# 	(sim_market.MultiCompetitorScenario(), vendors.QLearningAgent(sim_market.MultiCompetitorScenario().observation_space.shape[0], n_actions=10, optim=torch.optim.Adam)),
