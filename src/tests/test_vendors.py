...
from src.agents.vendors import CompetitorJust2Players as C2Players
from src.agents.vendors import CompetitorLinearRatio1 as CLinear1
from src.agents.vendors import CompetitorRandom as CRandom
