...
odd_number_of_customers = (create_mock_json('50', '50', '80', '21', '10'), 'number_of_customers should be even and positive')
negative_number_of_customers = (create_mock_json('50', '50', '80', '-10', '10'), 'number_of_customers should be even and positive')
...
prod_price_higher_max_price = (create_mock_json('50', '10', '80', '20', '50'), 'production_price needs to smaller than max_price and positive or zero')
neg_prod_price = (create_mock_json('50', '50', '80', '20', '-10'), 'production_price needs to smaller than max_price and positive or zero')
neg_max_quality = (create_mock_json('20', '15', '-80', '30', '5'), 'max_quality should be positive')
...
missing_max_price = (create_mock_json_with_missing_line(1), 'your config is missing max_price')
missing_max_quality = (create_mock_json_with_missing_line(2), 'your config is missing max_quality')
missing_number_of_customers = (create_mock_json_with_missing_line(3), 'your config is missing number_of_customers')
missing_prod_price = (create_mock_json_with_missing_line(4), 'your config is missing production_price')
