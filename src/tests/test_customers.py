...
def test_linear_higher_price_lower_purchase_probability():
	...
	probability_distribution = customer.CustomerLinear.generate_purchase_probabilities_from_offer(customer.CustomerLinear, common_state, vendor_specific_state, vendor_actions)
...
def test_linear_lower_overall_price_lower_nothing_probability():
	...
	probability_distribution1 = customer.CustomerLinear.generate_purchase_probabilities_from_offer(customer.CustomerLinear, common_state1, vendor_specific_state1, vendor_actions1)
	common_state2, vendor_specific_state2, vendor_actions2 = np.array([]), [[15], [15]], [4, 4]
	probability_distribution2 = customer.CustomerLinear.generate_purchase_probabilities_from_offer(customer.CustomerLinear, common_state2, vendor_specific_state2, vendor_actions2)
...
def test_circular_higher_price_lower_purchase_probability():
	...
	probability_distribution = customer.CustomerCircular.generate_purchase_probabilities_from_offer(customer.CustomerCircular, common_state, vendor_specific_state, vendor_actions)
