...
test_validate_config_not_final_still_needs_both_testcases = [
...
@pytest.mark.parametrize('config, is_final', test_validate_config_not_final_still_needs_both_testcases)
